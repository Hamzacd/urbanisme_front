...
export class CardStatistiqueComponent implements OnInit {
  // public
  public contraction : number;
  public reparation : number;
  public lotissement : number;
  public habiter : number;
  ...
  ngOnInit(): void {
    ...
    this.getCountConstraction();
    this.getCountReparation();
    this.getCountLotissement();
    this.getCountHabiter();
  ...
  async getCountConstraction() {
     this.dataService
      .get('get_count_constraction')
      .subscribe(async (res: any) => {
        if (res.success) {
            this.contraction = await res.data;
        }
      },
      async (error: any) => {
        console.log(error)
  ...
  async getCountReparation() {
    this.dataService.get('get_count_reparation').subscribe(async (res: any) => {
       if (res.success) {
           this.reparation = await res.data;
       }
     },
     async (error: any) => {
       console.log(error)
 ...
 async getCountLotissement() {
  this.dataService.get('get_count_lotissement').subscribe(async (res: any) => {
     if (res.success) {
         this.lotissement = await res.data;
     }
   },
   async (error: any) => {
     console.log(error)
...
async getCountHabiter() {
  this.dataService.get('get_count_habiter').subscribe(async (res: any) => {
     if (res.success) {
         this.habiter = await res.data;
     }
   },
   async (error: any) => {
     console.log(error)
